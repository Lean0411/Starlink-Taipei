...
def process_time_point_worker(
    time_data_tuple,
    worker_tle_list_of_tuples,
    worker_observer_lat,
    worker_observer_lon,
    worker_observer_elev,
    worker_ts_init_args,
...
def main():
    ...
    parser.add_argument("--no-prediction", action="store_true", help="禁用預測分析")
