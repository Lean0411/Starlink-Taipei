        ...
        for satellite in satellites:
            ...
            try:
                ...
                azimuth, elevation, distance = self.orbit_calculator.calculate_pass_details(
                    satellite, observer.position, time
                )
            ...
            if snapshot.visible_count >= min_satellites:
                ...
                if current_window is not None:
                    ...
                    if duration >= min_duration_minutes:
                        ...
                        current_window['avg_satellites'] = sum(current_window['satellite_counts']) / len(current_window['satellite_counts'])
