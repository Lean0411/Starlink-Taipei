...
torch_mock.no_grad = lambda: type('no_grad', (), {'__enter__': lambda self: None, '__exit__': lambda self, *args: None})()
...
sklearn_preprocessing_mock.StandardScaler = type('StandardScaler', (), {
