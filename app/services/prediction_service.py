...
class MultiScalePredictionService:
    ...
    def predict_satellite_coverage(
        self,
        observer_lat: float,
        observer_lon: float,
        prediction_type: str = "medium_term",
        satellites_subset: Optional[List[str]] = None,
    ) -> Dict:
        """
        預測衛星覆蓋率
    ...
    def predict_optimal_observation_windows(
        self,
        observer_lat: float,
        observer_lon: float,
    ...
    def generate_prediction_report(
        ...
        observer_lat: float,
        observer_lon: float,
        output_path: str = "output/prediction_report.json",
    ) -> str:
        """
        生成完整的預測報告
